...
$insquery= "INSERT INTO universities VALUES ('','$univ_name','$photoname1','$photoname2','$descripton','1','','')";
$runinsqry = mysql_query($insquery);
                ...
                <form class="form-horizontal" action="" enctype="multipart/form-data" method="post">
                  <div class="box-body">
                    ...
                    <div class="form-group">
                      ...
                      <div class="col-sm-8">
                        <input type="text" class="form-control" placeholder="" name="univ_name">
                      </div>
                    </div>
                    ...
                    <div class="form-group">
                      ...
                      <div class="col-sm-8">
                        <input type="file" class="form-control" placeholder="" name="logoimg">
                      </div>
                    </div>
                    ...
                    <div class="form-group">
                      ...
                      <div class="col-sm-8">
                        <textarea style="height:100px;" name="descripton" class="form-control"></textarea>
                      </div>
                    </div>
                    ...
                    <tbody>
                     <?php
                      ...
                      <tr>
                        ...
                        <td><?php echo substr($row['univ_description'],0,250);?>..</td>
                        
                        <td nowrap="true">
                            <a href="delete_univ.php?id=<?php echo $row['id'];?>">delete</a>|
                            <a href="edit_univ.php?id=<?php echo $row['id'];?>">edit</a>
                        </td>
                      </tr>
                     <?php }?>
                    </tbody>
