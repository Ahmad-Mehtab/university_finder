...
$name            =  $_POST['input_faculty'];
$designation     =  $_POST['input_designation'];
$degree          =  $_POST['degree'];
$institute       =  $_POST['institute'];


$result_query= mysql_query("INSERT INTO faculty_members (university_id, department_id ,  faculty_name ,  designation , heighest_degree , degree_institute) VALUES ('$univ_id','$department_name' , '$name' , '$designation' , '$degree' , '$institute') ")or die(mysql_error());
...
<div class="col-sm-6">
<input type="text" class="form-control" placeholder="Faculty Name" name="input_faculty">
</div>
</div>
...
<div class="col-sm-6">
<input type="text" class="form-control" placeholder="Designation" name="input_designation">
</div>
</div>

<div class="form-group">
<label for="inputPassword3" class="col-sm-2 control-label">Heighest Degree</label>
<div class="col-sm-6">
<input type="text" class="form-control" placeholder="Heighest Degree" name="degree">
</div>
</div>

<div class="form-group">
<label for="inputPassword3" class="col-sm-2 control-label">Degree institute</label>
<div class="col-sm-6">
<input type="text" class="form-control" placeholder="Degree institute" name="institute">
</div>
</div> 
...
<tbody>
<?php
$delete = mysql_query("SELECT * FROM faculty_members");
...
<td nowrap="true">
<a href="delete_faculty.php?id=<?php echo $row['id'];?>">delete</a>|
<a href="#.">edit</a>
</td>
</tr>
<?php }?>
